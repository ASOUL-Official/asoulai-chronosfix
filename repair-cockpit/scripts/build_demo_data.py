...
def build_demo_data() -> dict[str, Any]:
    ...
    return {
        ...
        "product": {
            ...
            "name": "ChronosFix",
            "short_name": "A-CFX",
            "title": "AsoulAI ChronosFix（A-CFX）",
            "subtitle": "带证明的软件变更基础设施 · 让每一次软件变更都携带可验证的证据",
        },
        "links": [
            {
                "label": "源码仓库",
            ...
            {
                "label": "完整方案 PDF",
                "href": "https://github.com/ASOUL-Official/asoulai-chronosfix/blob/main/submission/ChronosFix_%E5%A4%8D%E8%B5%9B%E6%96%B9%E6%A1%88.pdf",
            },
            {
                "label": "90 秒答辩 PDF",
                "href": "https://github.com/ASOUL-Official/asoulai-chronosfix/blob/main/submission/ChronosFix_90%E7%A7%92%E7%AD%94%E8%BE%A9%E7%89%88.pdf",
            },
            {
                "label": "工程 PR #3",
                "href": "https://github.com/ASOUL-Official/asoulai-chronosfix/pull/3",
            },
        ],
        "truthful_status": [
            {
                "label": "本地 Controller 证据",
                "value": "executed",
                "detail": "真实 Worker 子进程、失败重派与 SQLite 事件日志已有可复核证据；静态页面本身不执行后端。",
            },
            {
                "label": "GitHub 工程验证",
                "value": "passed",
                "detail": "公开 PR #3 已形成真实分支、三版本 CI 与验收 Artifact；自动修复 PR 仍为本地草案。",
            },
            {
                "label": "官方 AgentTeams / 云调用",
                "value": "pending",
                "detail": "本项目不把本地兼容 Controller、基础设施适配器或 dry-run 冒充官方部署。",
            },
        ],
        "revision": {
