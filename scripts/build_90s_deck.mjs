...
const edits = {
  ...
  3: {
    ...
    "sh/g72x4zyd": "8 个逻辑 Worker、备份实例、PID、duration_ms、SQLite Matrix；官方 AgentTeams 仍明确标 pending。",
    "sh/6h0fypgb": "Manager",
...
const notes = {
  ...
  2: "0:12–0:27 先讲结果：48.72% 到 6.25% 的既有评测口径、8 个强制故障变体、14 条证据声明；新增本地真实执行与 54 项测试。\n[Sources]\n- Internal: docs/evaluation-corpus-results.md\n- Internal: tests/ (pytest collection: 54)",
