...
| 评测结果和自动化验证证据 | `evidence/evaluation-report.md`、`evidence/evaluation-corpus/`、`scripts/run_semifinal_acceptance.py` | 已完成 | 12 个合成场景、66 项测试、严格 JSON/JSONL、Schema、资源校验和 CI 验收均可重跑 |
