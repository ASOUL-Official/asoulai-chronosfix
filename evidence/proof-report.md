...
**质量门禁：** passed
**发布决策：** approved
**Trace ID：** 0fdafeec5e6a46d1b53b5ce4675cbdbd
...
- `run_id`：`run-9aa3e27a48f74962a6e618779bee212f`
- `trace_id`：`0fdafeec5e6a46d1b53b5ce4675cbdbd`
...
具名审批人：`AsoulAI Release Owner`；审批时间：`2026-09-01T11:18:13.882843+00:00`。
